...
const typeNames = {
    ...
    ex: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M3 12l9-9 9 9v9a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1v-9z" stroke-linecap="round" stroke-linejoin="round"/></svg> Exposition',
...
const sections = [
    {
        name: 'Architecture',
        courses: ["opening", "ws", "snack", "archi-pt", "archi-geo", "archi-tb", "archi-m3D", "archi-expo", "archi-hat", "archi-math", "surprise"]
    },
    {
...
const COURSES = {
    ...
    "archi-geo": {
        "name": "Géométrie",
        "courses": ["jeu 28 8h15-12h"],
        "exercices": ["jeu 28 13h45-15h30"]
    },
    "archi-pt": {
        "name": "Théorie du projet",
        "courses": ["ven 29 8h15-12h"],
        "exercices": ["ven 29 13h45-15h30"]
    },
    "archi-tb": {
        "name": "Technologie du bâtiment",
        "courses": ["sam 30 8h15-12h"],
        "exercices": ["sam 30 13h45-15h30"]
    },
    "archi-m3D": {
        "name": "Modélisation 3D",
        "courses": ["lun 1 8h15-12h"],
        "exercices": ["lun 1 13h45-15h30"]
    },
    "archi-expo": {
        "name": "Exposition",
        "exposition": ["mar 2 8h15-12h", "mar 2 13h45-15h30"]
    },
    "archi-hat": {
        "name": "Histoire de l'architecture et territoire",
        "courses": ["mer 3 8h15-10h"]
    },
    "archi-math": {
        "name": "Mathématique pour architecte",
        "courses": ["mer 3 10h15-12h"],
        "exercices": ["mer 3 13h45-15h30"]
    },
    "surprise": {
        "name": "Surprise",
